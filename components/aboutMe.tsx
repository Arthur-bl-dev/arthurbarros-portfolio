...
import * as animationData from '../public/animations/abstract_animation.json'
    ...
    return (
        <>
            <div className={styles.contentAboutMe}>
                <BackgroundTextContent position="bottom left" title="I’m" />
                ...
                <div className={styles.right}>
                    <Image src="https://via.placeholder.com/750x750/18191c/9c9e9e.jpeg?text=Under+construction" alt="Arthur" width={650} height={650} />
                    <div hidden className={styles.contentAnimationPhoto}>
                        <Lottie
